...
export const MARCO_PHONE_CAPTURED_REPLY = "Awesome, I'll get that over to you.";
...
export const MARCO_PHONE_ASK_REPLY =
  "Yeah, of course — is there a good number I can get that over to?";

/** Bucket F: lead clearly confirmed in-state (Texas / San Antonio), pre-phone. */
export const MARCO_CALL_ASK_INSTATE =
  "Awesome — would you be open to a quick call sometime this week, just so I can get a better understanding of what you're looking for?";
...
export const MARCO_CALL_NUMBER_ASK_REPLY = "Great — what's the best number to reach you at?";
