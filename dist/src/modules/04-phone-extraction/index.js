...
async function process(lead, conversation) {
    ...
    // Still pushing price/address here — short deflection only (no "prioritize my time" lecture).
    if (/\b(price|how much|address|where is it|located|what.?s the)\b/.test(lower)) {
