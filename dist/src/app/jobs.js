...
const index_js_16 = require("../agents/luxuryContent/index.js");
...
function scheduleContentJobs() {
    ...
    (0, index_js_16.scheduleLuxurySweep)();
    (0, dailyDigest_js_1.scheduleDailyDigest)();
    (0, weeklyKPI_js_1.scheduleWeeklyKPI)();
    (0, index_js_17.scheduleWeeklyFinanceSummary)();
    (0, index_js_17.scheduleMonthlyCloseReport)();
    (0, index_js_17.schedulePaceCheckDaily)();
    (0, index_js_17.scheduleExpenseSpikeCheckWeekly)();
