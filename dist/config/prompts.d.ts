...
export declare const GLOBAL_MARCO_DM_RULES: string;
/** Preflight analyst: JSON coaching for the next Marco reply. */
export declare const GLOBAL_PREFLIGHT_RULES: string;
 ...
 */
export declare function getMarcoUnifiedPipelineSystem(): string;
