...
exports.HARVEY_HOUSE_STYLE = void 0;
exports.stripAiTypography = stripAiTypography;
 ...
 */
function stripAiTypography(text) {
    if (!text)
        return text;
 ...
 * old one.
 */
exports.HARVEY_HOUSE_STYLE = `HOW YOU WRITE (every task, report, note and message a person will read)
