...
export const PLATFORM_TOOL_DEFINITIONS: Tool[] = [
  ...
  },
  {
    name: "browser_fill",
    description:
      "Type values into form fields — a map of CSS selector to value. If you don't know the field selectors, call browser_read first; common ones ('#email', 'input[name=username]') can be tried directly. " +
