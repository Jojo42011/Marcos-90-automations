 ...
 */
export const MARCO_POST_CAPTURE_FOLLOWUP =
  "Are there any other specifics you'd like me to know about what you're searching for in a home?";
...
- If FUNNEL_CONTEXT.phone_just_captured is true, end your reply with exactly this question, once: "${MARCO_POST_CAPTURE_FOLLOWUP}" This is a single open-ended ask about their search, never a price/area/budget qualifying question, and it must never repeat later in the thread.
