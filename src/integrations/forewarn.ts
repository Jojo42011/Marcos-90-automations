...
import type { SkipTraceResult } from "../core/types.js";
...
async function forewarnApiLookup(phone: string, apiKey: string): Promise<SkipTraceResult> {
...
export async function runSkipTrace(phone: string): Promise<SkipTraceResult> {
