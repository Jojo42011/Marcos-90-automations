...
export const PLATFORM_TOOL_DEFINITIONS: Tool[] = [
  ...
  },
  {
    name: "browser_read",
    description:
      "Read the visible text of the current page, or of one region. If you have no tab of your own open, this reads THE TAB THE OPERATOR IS ON, so \"read what's on my screen\" works without any setup. Call this after navigating so you can see what's actually there before clicking or extracting — never guess a page's structure. " +
