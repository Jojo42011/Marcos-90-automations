...
exports.INTERNAL_CALL_HEADER = void 0;
exports.internalCallHeaders = internalCallHeaders;
exports.isInternalCall = isInternalCall;
/**
...
function internalCallHeaders() {
    return { [exports.INTERNAL_CALL_HEADER]: INTERNAL_CALL_TOKEN };
}
